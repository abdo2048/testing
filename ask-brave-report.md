...
### 6.4 Shopping / discussions / videos
Product cards include prices (e.g. `$447.00`). Discussions surface Reddit-style threads (carousel "View all 10"). Videos include `url`, YouTube titles with durations and dates.
